...
function file_input()
{
	...
	jQuery(document).on('change', '.btn-file :file', function() {
		...
		var	label = input.val().replace(/\\/g, 'https://gardencare.w3itexperts.com/').replace(/.*\//, '');
...
function handleSupport(){
		...
		var support = '<a href="https://www.templatemonster.com/website-templates/gardencare-gardening-for-flowers-fruits-vegetable-planting-landscaping-website-template-68382.html?aff=rahulxarma" target="_blank" class="bt-buy-now theme-btn"><i class="ti-shopping-cart"></i><span>Buy Now</span></a>';
